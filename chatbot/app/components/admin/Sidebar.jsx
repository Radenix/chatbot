        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-Manrope font-semibold text-[#121417]">
                Add New User
              </h2>
              <button
                onClick={() => setIsModalOpen(false)}
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-3">
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500 placeholder:text-gray-500"
                />
                <select
                  name="businessType"
                  value={formData.businessType}
                  onChange={handleInputChange}
                  className="w-full border border-gray-300 rounded-lg px-3 py-[11px] focus:outline-none focus:ring focus:ring-blue-500"
                >
